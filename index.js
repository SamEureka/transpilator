...
/***/ function(module, exports, __webpack_require__) {
	...
	var _htmlConfig, _jsxConfig, _jadeConfig, _markdownConfig, _javascriptConfig;
	...
	function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } // Import the modules
	...
	var config = {
	  htmlConfig: (_htmlConfig = {
	    ...
	    matchBrackets: true,
	    theme: 'default'
	  }, _defineProperty(_htmlConfig, 'styleActiveLine', true), _defineProperty(_htmlConfig, 'matchBrackets', true), _defineProperty(_htmlConfig, 'mode', {
	    name: "htmlmixed",
	    alignCDATA: true
	  }), _htmlConfig),
	  jsxConfig: (_jsxConfig = {
	    lineWrapping: true,
	    smartIndent: false,
	    indentWithTabs: true,
	    tabSize: '2',
	    ...
	    matchBrackets: true,
	    theme: 'default'
	  }, _defineProperty(_jsxConfig, 'styleActiveLine', true), _defineProperty(_jsxConfig, 'matchBrackets', true), _defineProperty(_jsxConfig, 'mode', "jsx"), _jsxConfig),
	  jadeConfig: (_jadeConfig = {
	    keyMap: "sublime",
	    smartIndent: false,
	    indentWithTabs: true,
	    lineWrapping: true,
	    ...
	    matchBrackets: true,
	    theme: 'default'
	  }, _defineProperty(_jadeConfig, 'styleActiveLine', true), _defineProperty(_jadeConfig, 'matchBrackets', true), _defineProperty(_jadeConfig, 'mode', {
	    name: "jade",
	    alignCDATA: true
	  }), _jadeConfig),
	  markdownConfig: (_markdownConfig = {
	    lineWrapping: true,
	    smartIndent: false,
	    indentWithTabs: true,
	    tabSize: '2',
	    ...
	    matchBrackets: true,
	    theme: 'default'
	  }, _defineProperty(_markdownConfig, 'styleActiveLine', true), _defineProperty(_markdownConfig, 'matchBrackets', true), _defineProperty(_markdownConfig, 'mode', {
	    name: "markdown"
	  }), _markdownConfig),
	  javascriptConfig: (_javascriptConfig = {
	    lineWrapping: true,
	    smartIndent: false,
	    indentWithTabs: true,
	    tabSize: '2',
	    ...
	    matchBrackets: true,
	    theme: 'default'
	  }, _defineProperty(_javascriptConfig, 'styleActiveLine', true), _defineProperty(_javascriptConfig, 'matchBrackets', true), _defineProperty(_javascriptConfig, 'mode', {
	    name: "javascript"
	  }), _javascriptConfig)
	};
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'getOutputConfig',
	    value: function getOutputConfig() {
	      switch (this.state.selected) {
	        case "jade":
	    ...
	    value: function checkLocalStorage() {
	      ...
	      if (!email) {
	        ...
	        this.setState({
	          'email': email,
	          'grav': (0, _md2.default)(email)
	        });
	      }
	    }
	  }, {
	    key: 'handleGravClick',
	    value: function handleGravClick() {
	      this.state.enterId === false ? this.setState({
	        enterId: true
	      }) : this.setState({
	        enterId: false
	      });
	    ...
	    key: 'handleGravInput',
	    value: function handleGravInput(e) {
	      e.preventDefault();
	      var input = e.target.value;
	      this.setState({
	        email: input,
	        grav: input === '' ? '' : (0, _md2.default)(input)
	      });
	      localStorage.setItem('email', input);
	    }
	  }, {
	    key: 'handleGravSubmit',
	    value: function handleGravSubmit(e) {
	      e.preventDefault();
	    ...
	    key: 'renderJade',
	    value: function renderJade(e) {
	      var code = jade.render(e, {
	        pretty: ' '
	      });
	      this.setState({
	        'text': e,
	    ...
	    key: 'renderCoffeeScript',
	    value: function renderCoffeeScript(e) {
	      var code = CoffeeScript.compile(e, {
	        bare: true
	      });
	      this.setState({
	        'text': e,
	    ...
	    key: 'renderJSX',
	    value: function renderJSX(e) {
	      var output = Babel.transform(e, { presets: ['es2015', 'react'] }).code;
	      this.setState({
	        'text': e,
	        'rendered': output,
	        'displayErr': false
	    ...
	    key: 'renderMarkdown',
	    value: function renderMarkdown(e) {
	    ...
	    key: 'renderLiveScript',
	    value: function renderLiveScript(e) {
	      var code = LiveScript.compile(e, {
	        bare: true
	      });
	      this.setState({
	        'text': e,
	    ...
	    value: function componentDidMount() {
	      var btn = document.getElementById('clipButton');
	      var clipboard = new Clipboard(btn);
	      var editorOut = CodeMirror.fromTextArea(this.refs.editorOut, this.getOutputConfig());
	      var editorIn = CodeMirror.fromTextArea(this.refs.editorIn, this.getInputConfig());
	      editorIn.on("change", function () {
	        var temp = editorIn.doc.getValue();
	        this.update(temp);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(Pick, { handleSelect: this.handleSelectChange.bind(this) }),
	        _react2.default.createElement(
	          'h2',
	          { id: 'title' },
	          _react2.default.createElement('i', { className: 'blue fa fa-code' }),
	          ' ',
	          'TRANSPILATOR'
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('span', { className: 'cl fa fa-clipboard fa-2x' })
	          ),
	          _react2.default.createElement('textarea', {
	            className: 'codemirror',
	            ref: 'editorOut',
	...
	var Gravatar = function (_React$Component2) {
	  _inherits(Gravatar, _React$Component2);
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', {
	              id: 'gravInput',
	              type: 'text',
	              style: this.props.enterId ? styles.boom : styles.hidden,
	...
	var Pick = function (_React$Component3) {
	  _inherits(Pick, _React$Component3);

	  function Pick() {
	    _classCallCheck(this, Pick);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Pick).apply(this, arguments));
	  }
	  ...
	  _createClass(Pick, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'select',
	        { style: styles.pick, onChange: this.props.handleSelect },
	        _react2.default.createElement(
	          'option',
	          { value: 'jade' },
	          'Jade'
	...
	var Error = function (_React$Component4) {
	  _inherits(Error, _React$Component4);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          {
	            style: this.props.displayErr ? styles.error : styles.hidden },
	          this.props.err
	        )
	      );
	    }
